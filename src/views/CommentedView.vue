    ...
    " />
        ...
        <div class="w-[75%]">
          <div class="flex items-center gap-[15px]">
            <img class="w-[50px] h-[50px] btn-circle" :src="currentUser.imageUrl" />
            <div class="font-bold text-[22px]">{{ currentUser.username }}</div>
            <div class="flex gap-[10px] ml-[auto]">
              <div @click="reviewModalHandler(true, index)" class="hover:text-gray-300">
                <button>Edit</button>
              </div>
