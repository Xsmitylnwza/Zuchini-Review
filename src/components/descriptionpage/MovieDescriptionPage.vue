...
onMounted(async () => {
  try {
    ...
    const urlcredit = `https://api.themoviedb.org/3/movie/${
      route.fullPath.split("/")[2]
...
<template>
  ...
  >
    <div class="bg-layers h-[100%]">
      <NavBar />
      <div
        class="w-[75%] m-[auto] font-istok text-white px-[45px] py-[10px] blackBackground"
      >
        ...
        <div class="flex justify-between mb-[20px]">
          <div class="w-[25%]">
            <img
              class="w-[225px]"
              :src="
                'https://image.tmdb.org/t/p/w500/' + infoDetails.poster_path
              "
            />
          </div>
