...
const reviewItems = [
  {
    icon: reviewIconCamera,
    label: 'Performance',
    value: props.rating[0].toFixed(2),
  },
  {
    icon: reviewIconCinema,
    label: 'Production',
    value: props.rating[1].toFixed(2),
  },
  {
    icon: reviewIconChapter,
    label: 'Movie Chapter',
    value: props.rating[2].toFixed(2),
  },
  {
    icon: reviewIconWatching,
    label: 'Entertainment',
    value: props.rating[3].toFixed(2),
  },
  {
    icon: reviewIconMoney,
    label: 'Worthiness',
    value: props.rating[4].toFixed(2),
  },
]
