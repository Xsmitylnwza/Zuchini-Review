...
<template>
  ...
  <div v-else class="flex flex-col">
    <div class="relative ml-[auto] rouned-[10px]">
      <select
        class="text-white font-bold p-[1px] bg-black"
    ...
    <div
      class="w-[100%] rounded-xl py-[10px] pt-[15px] font-istok hover:bg-gray-600 hover:bg-opacity-70"
    ...
    >
      ...
      <div class="flex flex-row items-center justify-end gap-[5px] mr-3">
        <span class="mt-1"
          >Liked {{ review.likeCount ? review.likeCount : '0' }}</span
        >
        <svg
          width="23"
          height="23"
