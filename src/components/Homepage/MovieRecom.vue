...
<template>
  ...
  >
    ...
    >
      <a :href="'#slide' + (index === 0 ? 4 : index - 1)" class="m-auto mr-11"
        ><svg
          width="35"
          height="66"
          viewBox="0 0 35 66"
    ...
    <RouterLink :to="{ path: '/movie/' + movie.id }">
      <div
        class="blackBackground rounded-[15px] laptop:flex justify-center items-row w-[100%] h-[550px] p-[30px]"
      >
        <div class="w-[300px]">
          <img
        ...
        <div
          class="flex flex-col font-istok w-[800px] ml-8 text-white font-bold"
        >
          <h1
    ...
    <div
      class="flex relative bottom-[80px] hover:animate-pulse hover:animate-infinite transition ease-in-out delay-150 hover:scale-110 duration-300 animate-shake animate-twice animate-duration-200 animate-delay-200"
    >
      <a :href="'#slide' + (index === 4 ? 0 : index + 1)" class="m-auto ml-11"
        ><svg
          width="35"
          height="66"
          viewBox="0 0 35 66"
