...
<template>
  <div :id="'slide' + indexMovie" class="carousel-item relative w-full flex justify-center">
    <div class="flex">
      <a :href="'#slide' + (indexMovie - 1)" class="btn btn-outline m-auto mr-11 shadow-inner shadow-black ">❮</a>
    </div>
    ...
    <div class="flex">
      <a :href="'#slide' + (indexMovie + 1)" class="btn btn-outline m-auto ml-11 shadow-inner shadow-black ">❯</a>
    </div>
  </div>
                ...
                <div class="flex flex-col mb-[30px]">
                    ...
                    <div class="flex gap-2">
                        ...
                        <svg width="67" height="42" viewBox="0 0 67 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <circle cx="35" cy="21" r="20.5" stroke="#B00000" />
                            <circle cx="21" cy="21" r="20.5" fill="#B20707" stroke="#FF0404" />
                            <text x="12" y="26" font-family="Arial" font-size="14" fill="white">+2</text>
                        </svg>
