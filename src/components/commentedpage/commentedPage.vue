...
import RedBar from "../descriptionpage/RedBarTopic.vue";
...
<template>
  ...
  <reviewPage :open="showReview" @close="showReview = !showReview">
    <p>
      Chicago, Illinois, couple Valerie and Ted Rock took the cat in two years
      ago after they visited a local bar, where a group of drinkers were handing
      the animal around and making fun of him. Since being adopted by the Rocks
      and after getting his picture posted on the Internet, the two-year-old
      feline has become an international media celebrity.
    </p>
  </reviewPage>
</template>
