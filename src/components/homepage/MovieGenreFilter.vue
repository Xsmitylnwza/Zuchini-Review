...
<template>
  <div class="bg-black">
    <div ref="containerRef" class="flex flex-row items-center overflow-x-scroll overflow-y-clip gap-[20px] h-[325px]">
    ...
    <div class="w-full flex justify-between">
      <div
        class="relative flex items-center justify-center bottom-[200px] rounded-[10px] w-[55px] hover:opacity-85 cursor-pointer ml-2 transition ease-in-out delay-150 hover:scale-110 duration-300"
        @click="scrollLeft">
      ...
      <div
        class="relative flex items-center justify-center bottom-[200px] rounded-[10px] w-[55px] hover:opacity-85 cursor-pointer mr-2 transition ease-in-out delay-150 hover:scale-110 duration-300"
        @click="scrollRight">
        <svg width="35" height="66" viewBox="0 0 35 66" fill="none" xmlns="http://www.w3.org/2000/svg">
